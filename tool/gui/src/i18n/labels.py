...
HIDDEN_FIELDS: set[str] = {
    ...
    "maxSelections",
    "runtimeType",
    # Anki provenance / WebView plumbing — noise for the teacher view.
    "sourceNoteId",
    "sourceCardId",
    "mediaBasePath",
    "allowJs",
...
FIELD_LABELS_EN: dict[str, str] = {
    ...
    "audioAsset": "Audio",
    "audioAssets": "Audio list",
    "imageAssets": "Image list",
    "tags": "Tags",
    "wordId": "Word",
    "expressionId": "Expression",
    "grammarPointId": "Grammar point",
    "linkedGrammarPointIds": "Linked grammar points",
    "prompt": "Prompt",
    "options": "Options",
