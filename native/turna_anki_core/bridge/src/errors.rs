...
const ERROR_TABLE: &[(i32, &str, Option<&str>)] = &[
    ...
    (
        ...
        "INVALID_STATE",
        Some("official_anki.invalid_state"),
    ),
    (
    ...
    (
        ...
        "PACKAGE_NOT_FOUND",
        Some("official_anki.package_not_found"),
    ),
    (
        STATUS_PACKAGE_INVALID,
        "PACKAGE_INVALID",
        Some("official_anki.package_invalid"),
    ),
    (
        STATUS_IMPORT_CANCELLED,
        "IMPORT_CANCELLED",
        Some("official_anki.import_cancelled"),
    ),
    (
        STATUS_CARD_NOT_FOUND,
        "CARD_NOT_FOUND",
        Some("official_anki.card_not_found"),
    ),
    (
        STATUS_RENDER_FAILED,
        "RENDER_FAILED",
        Some("official_anki.render_failed"),
    ),
    (
        STATUS_QUEUE_EMPTY,
        "QUEUE_EMPTY",
        Some("official_anki.queue_empty"),
    ),
    (
        STATUS_SCHEDULING_CONTEXT_STALE,
        "SCHEDULING_CONTEXT_STALE",
        Some("official_anki.scheduling_context_stale"),
    ),
    (
        STATUS_ANSWER_FAILED,
        "ANSWER_FAILED",
        Some("official_anki.answer_failed"),
    ),
    (
        STATUS_ANSWER_COMMIT_UNKNOWN,
        "ANSWER_COMMIT_UNKNOWN",
        Some("official_anki.answer_commit_unknown"),
    ),
    (
        STATUS_UNDO_UNAVAILABLE,
        "UNDO_UNAVAILABLE",
        Some("official_anki.undo_unavailable"),
    ),
    (STATUS_IO_ERROR, "IO_ERROR", None),
    (STATUS_COLLECTION_CORRUPT, "COLLECTION_CORRUPT", None),
    (
        STATUS_CONTRACT_VERSION_MISMATCH,
        "CONTRACT_VERSION_MISMATCH",
        Some("official_anki.contract_version_mismatch"),
    ),
    (
        STATUS_PAGE_TOKEN_STALE,
        "PAGE_TOKEN_STALE",
        Some("official_anki.page_token_stale"),
    ),
    (
        STATUS_TYPED_FIELD_NOT_FOUND,
        "TYPED_FIELD_NOT_FOUND",
        Some("official_anki.typed_field_not_found"),
    ),
    (
        STATUS_TYPED_CLOZE_EMPTY,
        "TYPED_CLOZE_EMPTY",
        Some("official_anki.typed_cloze_empty"),
    ),
    (
        STATUS_PROJECTION_SNAPSHOT_STALE,
        "PROJECTION_SNAPSHOT_STALE",
        Some("official_anki.projection_snapshot_stale"),
    ),
    (
        STATUS_REDO_UNAVAILABLE,
        "REDO_UNAVAILABLE",
        Some("official_anki.redo_unavailable"),
    ),
    (
        STATUS_DECK_NOT_FOUND,
        "DECK_NOT_FOUND",
        Some("official_anki.deck_not_found"),
    ),
    (
        STATUS_SCHEDULER_BUSY,
        "SCHEDULER_BUSY",
        Some("official_anki.scheduler_busy"),
    ),
