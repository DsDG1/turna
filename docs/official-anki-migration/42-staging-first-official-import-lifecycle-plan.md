...
| P4 | （本波 commit） | `flutter test test/application/anki/official_anki_architecture_guard_test.dart test/application/anki_official/official_anki_import_orchestrator_test.dart test/application/anki_official/official_anki_recovery_test.dart test/application/anki_official/official_anki_lifecycle_storage_test.dart test/application/anki_official/official_anki_commit_live_test.dart test/application/anki_official/official_anki_staging_manager_test.dart test/views/anki/anki_import_staging_first_p0_test.dart test/application/anki_official/official_anki_projection_scope_p0_test.dart test/views/anki_official/official_anki_mapping_page_test.dart test/application/maintenance/storage_inventory_service_test.dart` | 删 live-first `importFile`/`createBackup` 预览路径；wizard/`importThenPreview` 只 `startStaging`；`restoreBackup` 仅存量 checkpoint；staging 库存分项；worker `importFile` 薄转 `importPackage`。 |
